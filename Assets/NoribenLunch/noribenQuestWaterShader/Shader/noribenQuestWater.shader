	...
	SubShader
	{
		...
		Pass
		{
			...
			v2f vert (appdata v)
			{
				...
				//テクスチャで頂点移動
				half4 heighttex = tex2Dlod(_HeightTex, half4(half2(o.uv.x + _Time.y * _Scrollx * 0.1, o.uv.y + _Time.y * _Scrolly * 0.1), 0, 0));
			...
			{	
				...
				//ノーマルマップ
				half3 normalmap = UnpackNormal(tex2D(_MainTex, half2(i.uv.x + _Time.y * _Scrollx * 0.1, i.uv.y + _Time.y * _Scrolly * 0.1)));
